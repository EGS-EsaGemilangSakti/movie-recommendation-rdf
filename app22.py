...
if option == "Search for a Movie":
    ...
    predefined_query = st.radio(
        "Select a Predefined Question",
        ("Top 10 Movies by Budget", "Top 10 Movies by Revenue", "Top 10 Movies by Runtime", "Top 10 Movies by Genre")
    )
    if predefined_query == "Top 10 Movies by Budget":
        query = """
        PREFIX ex: <http://example.org/>
        PREFIX schema: <http://schema.org/>
        PREFIX xsd: <http://www.w3.org/2001/XMLSchema#>
        ...
        LIMIT 10
        """
    elif predefined_query == "Top 10 Movies by Revenue":
        query = """
        PREFIX ex: <http://example.org/>
        PREFIX schema: <http://schema.org/>
        PREFIX xsd: <http://www.w3.org/2001/XMLSchema#>
        ...
        LIMIT 10
        """
    elif predefined_query == "Top 10 Movies by Runtime":
        query = """
        PREFIX ex: <http://example.org/>
        PREFIX schema: <http://schema.org/>
        PREFIX xsd: <http://www.w3.org/2001/XMLSchema#>
    ...
    predefined_results = run_sparql_query(query)
    st.write(predefined_results)
